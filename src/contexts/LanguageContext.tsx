...
const translations: Translations = {
  ...
  'compress.custom': { en: 'Custom Quality', id: 'Kustom (Sesuaikan)' },
  'compress.balanced.desc': { en: 'Significant size reduction while maintaining excellent image quality for web & social media.', id: 'Ukuran berkurang signifikan dengan kualitas gambar tetap terjaga sangat baik untuk web & media sosial.' },
  'compress.maximum.desc': { en: 'Smallest file size possible. Perfect for saving maximum storage when fine details are not critical.', id: 'Ukuran file sekecil mungkin. Sangat cocok untuk menghemat penyimpanan maksimal jika detail kecil tidak terlalu penting.' },
  'compress.highQuality.desc': { en: 'Nearly perfect quality compared to the original, with lightweight compression.', id: 'Kualitas hampir sempurna dibanding aslinya dengan kompresi yang lebih ringan.' },
  'compress.custom.desc': { en: 'Manually adjust the quality percentage using the slider below.', id: 'Atur persentase kualitas kompresi secara manual menggunakan slider di bawah.' },
